...
- Dynamic alias discovery should stay free-only, prefer an OpenCode Zen worker for startup bucketing when available, and fall back to OpenRouter only when Zen cannot supply a usable worker.
