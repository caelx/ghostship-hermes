...
- Constrain high-backtracking upstream Hermes extras in the Dockerfile when installing `hermes-agent[all]`; broad messaging/matrix ranges can make pip hit `resolution-too-deep` before it finds valid leaves.
