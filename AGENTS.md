...
- Constrain high-backtracking upstream Hermes extras in the Dockerfile when installing `hermes-agent[all]`; broad messaging, matrix, Daytona, and related ranges can make pip hit `resolution-too-deep` before it finds valid leaves.
