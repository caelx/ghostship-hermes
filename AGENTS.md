...
- Coding-family priors should strongly bias the coding alias after capability and free-only filters, and recency bias should be meaningful enough to lift newer families rather than acting only as a weak tie-breaker.
