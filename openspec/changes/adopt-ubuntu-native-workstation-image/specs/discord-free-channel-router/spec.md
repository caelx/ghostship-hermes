...
The managed Hermes runtime SHALL force Discord free-response sessions to use the local `ghostship-hermes-router` endpoint instead of the managed runtime's default direct model path.
