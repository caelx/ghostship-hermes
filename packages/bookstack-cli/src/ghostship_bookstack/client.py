...
class BookStackClient(BaseHttpClient):
    ...
    def request(
        ...
        *,
        ...
        spec = self.build_request(method, path, query_params=query_params, json_body=json_body, form_data=form_data, files=files, headers=headers, timeout=timeout)
        return self.request_decoded(spec.method, spec.path, params=spec.params, json_body=spec.json_body, form_data=spec.form_data, files=spec.files, headers=spec.headers, timeout=spec.timeout)
    ...
    def request_operation(
        ...
        *,
        ...
        if operation.response_kind == 'json':
            return self.request_json(spec.method, spec.path, params=spec.params, json_body=spec.json_body, form_data=spec.form_data, files=spec.files, headers=spec.headers, timeout=spec.timeout)
