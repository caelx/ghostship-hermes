...
- coding, agentic, and auxiliary candidates all get alias-specific family priors based on repo-maintained benchmark guidance; newer models get a strong recency lift after capability filtering; `vision` prefers larger models while `auxiliary` intentionally prefers smaller helper models
