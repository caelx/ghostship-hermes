...
def main() -> None:
    ...
    for old, new in (
        ...
        (
            ...
            """        forced_channel = self._ghostship_discord_forced_channel(source)\n        if forced_channel == \"router\":\n            self._session_model_overrides.pop(session_key, None)\n            return \"This Discord router channel is pinned to ghostship-router (`agentic`).\"\n        if forced_channel == \"deepthink\":\n            self._session_model_overrides.pop(session_key, None)\n            return \"This Discord #deepthink channel is pinned to Codex `gpt-5.4` with high reasoning.\"\n\n        # No args: show interactive picker (Telegram/Discord) or text list\n        if not model_input and not explicit_provider:\n""",
        ),
        (
