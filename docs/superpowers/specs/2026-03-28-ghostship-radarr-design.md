# Ghostship-Radarr Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement a fully featured CLI utility for the Radarr API.
...
**Files:**
- Create: `packages/radarr-cli/pyproject.toml`
- Create: `packages/radarr-cli/package.nix`
- Create: `packages/radarr-cli/src/ghostship_radarr/__init__.py`
- Create: `packages/radarr-cli/src/ghostship_radarr/cli.py`
- Create: `packages/radarr-cli/tests/test_cli.py`
...
**Files:**
- Create: `packages/radarr-cli/src/ghostship_radarr/client.py`
