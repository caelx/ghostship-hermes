# Ghostship-Qbittorrent Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement a fully featured CLI utility for the Qbittorrent API.
...
**Files:**
- Create: `packages/qbittorrent-cli/pyproject.toml`
- Create: `packages/qbittorrent-cli/package.nix`
- Create: `packages/qbittorrent-cli/src/ghostship_qbittorrent/__init__.py`
- Create: `packages/qbittorrent-cli/src/ghostship_qbittorrent/cli.py`
- Create: `packages/qbittorrent-cli/tests/test_cli.py`
...
**Files:**
- Create: `packages/qbittorrent-cli/src/ghostship_qbittorrent/client.py`
...
**Files:**
- Create: `skills/qbittorrent/SKILL.md`
