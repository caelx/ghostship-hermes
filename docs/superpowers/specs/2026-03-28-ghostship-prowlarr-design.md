# Ghostship-Prowlarr Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement a fully featured CLI utility for the Prowlarr API.
...
**Files:**
- Create: `packages/prowlarr-cli/pyproject.toml`
- Create: `packages/prowlarr-cli/package.nix`
- Create: `packages/prowlarr-cli/src/ghostship_prowlarr/__init__.py`
- Create: `packages/prowlarr-cli/src/ghostship_prowlarr/cli.py`
- Create: `packages/prowlarr-cli/tests/test_cli.py`
...
**Files:**
- Create: `packages/prowlarr-cli/src/ghostship_prowlarr/client.py`
...
**Files:**
- Create: `skills/prowlarr/SKILL.md`
