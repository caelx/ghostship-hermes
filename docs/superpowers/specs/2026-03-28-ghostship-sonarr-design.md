# Ghostship-Sonarr Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement a fully featured CLI utility for the Sonarr API.
...
**Files:**
- Create: `packages/sonarr-cli/pyproject.toml`
- Create: `packages/sonarr-cli/package.nix`
- Create: `packages/sonarr-cli/src/ghostship_sonarr/__init__.py`
- Create: `packages/sonarr-cli/src/ghostship_sonarr/cli.py`
- Create: `packages/sonarr-cli/tests/test_cli.py`
...
**Files:**
- Create: `packages/sonarr-cli/src/ghostship_sonarr/client.py`
