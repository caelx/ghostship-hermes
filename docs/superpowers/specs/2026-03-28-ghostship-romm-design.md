# Ghostship-Romm Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement a fully featured CLI utility for the Romm API.
...
**Files:**
- Create: `packages/romm-cli/pyproject.toml`
- Create: `packages/romm-cli/package.nix`
- Create: `packages/romm-cli/src/ghostship_romm/__init__.py`
- Create: `packages/romm-cli/src/ghostship_romm/cli.py`
- Create: `packages/romm-cli/tests/test_cli.py`
...
**Files:**
- Create: `packages/romm-cli/src/ghostship_romm/client.py`
