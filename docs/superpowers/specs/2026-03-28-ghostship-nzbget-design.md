# Ghostship-Nzbget Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement a fully featured CLI utility for the Nzbget API.
...
**Files:**
- Create: `packages/nzbget-cli/pyproject.toml`
- Create: `packages/nzbget-cli/package.nix`
- Create: `packages/nzbget-cli/src/ghostship_nzbget/__init__.py`
- Create: `packages/nzbget-cli/src/ghostship_nzbget/cli.py`
- Create: `packages/nzbget-cli/tests/test_cli.py`
...
**Files:**
- Create: `packages/nzbget-cli/src/ghostship_nzbget/client.py`
