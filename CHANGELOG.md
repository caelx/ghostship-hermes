...
- Made `packages/hermes-dashboard` the canonical packaged MMX dashboard artifact, exposed it as a direct flake package, removed the stale image runtime asset-root seam, and updated the dashboard smoke test and docs to the MMX UI contract.
